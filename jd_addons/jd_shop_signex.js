/* 店铺签到增强版， 去除重复店铺，过滤掉失效店铺， 输出有效店铺组。
1 0,1,8 * * * jd_shop_signex.js, tag=店铺签到diy
*/
const $ = new Env('店铺签到');
...
const token = [...new Set(origin)] //去除重复的
...
function showAvaliableToken(){
    console.log("有效店铺token", availableList)
}
