...
# @Author  : hwkxk(丶大K丶)
# @Email   : k@hwkxk.cn
# update:2021/9/8 : 移除configini, 从以下环境变量读取ua和cookie
# export ht_ua='xx' 
# export ht_cookie='xx'

import requests,json,time,logging,traceback,os,random,datetime,configparser
...
def main(event, context):
    ...
    HT_cookies = os.environ['ht_cookie']
    # HT_UserAgent = users.get("config","User-Agent")
    HT_UserAgent = os.environ['ht_ua']
