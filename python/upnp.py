...
try:
    ...
    b = u.addportmapping(2222, 'TCP', '192.168.18.120', 22,'UPnP IGD Tester port %u' % eport, '')
    b = u.addportmapping(5700, 'TCP', '192.168.18.120', 5700,'UPnP IGD Tester port %u' % eport, '')
    b = u.addportmapping(1043, 'TCP', '192.168.18.120', 1043,'UPnP IGD Tester port %u' % eport, '')
    if b:
        ...
        if 0:
            ...
            print('UPNP有效期也就几天，不续订就gerp，局域网设备不在线也gerp')
    else:
        print('Failed')
